   ...
   <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white shadow-xl rounded-2xl p-10 w-full max-w-md">
        ...
        <div className="flex flex-col gap-4">
          <input placeholder="Cart Value"type="number"value={cartValue}onChange={e => setCartValue(e.target.value)}className="px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"/>

          <button onClick={evaluate}className="bg-purple-500 text-white py-3 rounded-lg font-semibold hover:bg-purple-600 transition-colors">Get Best Coupon</button>
